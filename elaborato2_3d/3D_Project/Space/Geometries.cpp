...
void boundingBox(Mesh *fig)
{
	...
	fig->corner.push_back(vec3(maxx, miny, minz));
	fig->corner.push_back(vec3(maxx, miny, minz));
	fig->corner.push_back(vec3(minx, maxy, minz));
	fig->corner.push_back(vec3(minx, maxy, minz));
	fig->corner.push_back(vec3(maxx, miny, maxz));
	fig->corner.push_back(vec3(maxx, miny, maxz));
	fig->corner.push_back(vec3(minx, maxy, maxz));
	fig->corner.push_back(vec3(minx, maxy, maxz));
}
